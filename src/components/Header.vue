        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  @click="$router.push('/ScnMake')">시나리오 생성</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" @click="$router.push('/ScnSelect')">시나리오 선택</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" @click="$router.push('/Board')">게시판</a>
                    </li>
                </ul>
            </div>
        </div>
